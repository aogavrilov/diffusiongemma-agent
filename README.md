...
1. [Download DiffusionGemmaAgentSetup-0.1.4.exe](https://github.com/aogavrilov/diffusiongemma-agent/releases/download/desktop-v0.1.4/DiffusionGemmaAgentSetup-0.1.4.exe).
